...
That's what [DinkyDash](/diy-skylight-calendar/) is for. It's a free, open-source family dashboard that turns any old tablet, spare monitor or [Raspberry Pi](/raspberry-pi-family-calendar/) into a screen on the kitchen wall showing today's calendar events, a chore chart that rotates between the kids, every birthday countdown, and a short daily message written fresh each day.
